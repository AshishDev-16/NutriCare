  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between px-2">
        <div>
          <h3 className="text-lg font-black text-slate-800 dark:text-slate-200">Dispatch Queue</h3>
          <p className="text-xs text-slate-400 font-bold uppercase tracking-widest mt-0.5">Floor-to-Floor Readiness</p>
        </div>
        <Select value={priorityFilter} onValueChange={setPriorityFilter}>
          <SelectTrigger className="w-[180px] bg-white dark:bg-[#1a2b3c] border-none shadow-sm rounded-xl font-bold text-slate-600 dark:text-slate-300">
            <SelectValue placeholder="All Prio" />
          </SelectTrigger>
